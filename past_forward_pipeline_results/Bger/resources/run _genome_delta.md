...
```bash
conda activate GenomeDelta_SarahMod
```
...
nohup bash /mnt/data5/sarah/app_GenomeDelta/linux/main.sh \
  ...
  --fa /mnt/data5/sarah/aDNA/Bger/raw/ref/Bgerracon1.fasta \
...
nohup bash /mnt/data5/sarah/app_GenomeDelta/linux/main.sh \
  ...
  --fa /mnt/data5/sarah/aDNA/Bger/raw/ref/GCA_000762945.2_Bger_2.0_genomic.fna \
